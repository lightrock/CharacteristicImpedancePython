...
from build_codata_docs import build, read_source_table, value_mantissa_digits  # noqa: E402
...
class CodataToolTests(unittest.TestCase):
    ...
    def test_source_table_preserves_z0_anchor(self):
        ...
        self.assertEqual(records[0].quantity, "characteristic impedance of vacuum")
        self.assertEqual(records[0].significant_digits, "376730313461")
        self.assertEqual(records[0].bits, "101011110110110111000000110001011110101")
    ...
    def test_build_recreates_generated_files(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            first_line = (out_dir / "pre-2019-codata-2014-bits-only.txt").read_text(encoding="utf-8").splitlines()[0]
            self.assertEqual(first_line, "101011110110110111000000110001011110101")
